...
func (m *MockRoutes) GetWakeMessage(serverAddress string) string {
	args := m.MethodCalled("GetWakeMessage", serverAddress)
	return args.String(0)
}

func (m *MockRoutes) GetWakeAllowlist(serverAddress string) []string {
	args := m.MethodCalled("GetWakeAllowlist", serverAddress)
...
func (m *MockRoutes) SetWakeConfig(serverAddress string, wakeMessage string, wakeAllowlist []string) {
	m.MethodCalled("SetWakeConfig", serverAddress, wakeMessage, wakeAllowlist)
}
